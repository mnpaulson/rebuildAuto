...
7. Optional: in the Lighting Manager window, create the minimap, then run "Update Addressables (Fast)".
8. Start the server with the **Minimal** launch profile. For example (`./run-server.cmd Minimal`)
